...
import EducatorSignUp from '@/components/forms/EducatorSignUp.vue';
import TitleMixin from '@/mixins/title';

@Component({
  components: {
    'educator-signup': EducatorSignUp
  }
})
export default class CreateEducatorAccount extends Mixins(TitleMixin) {
